...
Source0  : https://gitlab.com/mdds/mdds/-/archive/2.0.2/mdds-2.0.2.tar.gz
...
%prep
%setup -q -n mdds-2.0.2
cd %{_builddir}/mdds-2.0.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1649804555
...
cp %{_builddir}/mdds-2.0.2/LICENSE %{buildroot}/usr/share/package-licenses/mdds/9b284bb2e965bb644bd7945b4198c55020a2714a
%make_install
